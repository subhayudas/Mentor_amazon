...
/** Table: hairline rows, start-aligned headers, logical cell padding; numeric columns add `tabular-nums` themselves. */
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-12 px-4 text-start align-middle text-caption text-muted-foreground [&:has([role=checkbox])]:pe-0",
      className
    )}
    {...props}
  />
